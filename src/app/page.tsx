...
export default function Home() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-cyber-grid bg-gray-950 text-foreground selection:bg-cyber-cyan/30 selection:text-white">
      {/* Navbar */}
      <Header />
      ...
      <main className="flex-grow pt-24 pb-16 px-4 sm:px-6 relative">
        {/* Glow Ambient Blobs */}
        <div className="absolute top-1/4 left-1/4 -translate-x-1/2 w-72 h-72 rounded-full bg-cyber-indigo/10 blur-[100px] pointer-events-none" />
        <div className="absolute top-1/3 right-1/4 translate-x-1/2 w-80 h-80 rounded-full bg-cyber-cyan/10 blur-[120px] pointer-events-none" />
        <div className="absolute bottom-1/4 left-1/3 w-96 h-96 rounded-full bg-cyber-emerald/5 blur-[150px] pointer-events-none" />
        ...
        <div className="max-w-6xl mx-auto space-y-24">
          ...
          <section className="text-center md:text-left pt-6 md:pt-12 space-y-6">
            <div className="space-y-4">
              ...
              <div className="inline-flex items-center gap-2 bg-gray-950 px-3.5 py-1.5 rounded-full border border-gray-900 text-xs font-mono text-gray-400">
                <span className="w-2 h-2 rounded-full bg-cyber-emerald animate-ping" />
                Available for Senior Consulting & Architecture Roles
              </div>

              {/* Bold Title */}
              <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold tracking-tight font-sans text-white">
                Omer Bin Habib
              </h1>
              
              {/* Core Tagline */}
              <h2 className="text-lg sm:text-2xl md:text-3xl font-bold font-mono text-transparent bg-clip-text bg-gradient-to-r from-cyber-cyan via-cyber-indigo to-cyber-emerald">
                Senior Systems Engineer + Growth Architect
              </h2>

              <p className="max-w-3xl text-sm sm:text-base text-gray-400 font-sans leading-relaxed">
            ...
            <div className="flex flex-wrap items-center justify-center md:justify-start gap-4 pt-2">
              <a 
                href="#contact" 
                className="px-6 py-3 bg-cyber-cyan text-black font-semibold rounded font-mono text-xs cursor-pointer hover:bg-cyan-400 active:scale-95 transition-all shadow-[0_0_20px_rgba(6,182,212,0.3)]"
              >
                DISPATCH_PROPOSAL()
              </a>
              <a 
                ...
                className="px-6 py-3 bg-gray-900 border border-gray-800 text-gray-300 font-semibold rounded font-mono text-xs cursor-pointer hover:border-cyber-cyan hover:text-white active:scale-95 transition-all flex items-center gap-1.5"
              >
                <Download className="w-4 h-4" /> DOWNLOAD_RESUME.PDF
              </a>
            </div>
          ...
          <section id="console" className="space-y-4 text-center md:text-left">
            <div className="space-y-1">
              <h3 className="text-lg font-bold font-mono text-white flex items-center justify-center md:justify-start gap-2">
                <Terminal className="w-5 h-5 text-cyber-cyan" /> 01 // Interactive Developer Shell
              </h3>
          ...
          <section id="architecture" className="space-y-4">
            <div className="space-y-1 text-center md:text-left">
              <h3 className="text-lg font-bold font-mono text-white flex items-center justify-center md:justify-start gap-2">
                <Layers className="w-5 h-5 text-cyber-indigo" /> 02 // Interactive Systems Architecture
              </h3>
              <p className="text-xs text-gray-500 font-mono">
          ...
          <section id="api-explorer" className="space-y-4">
            <div className="space-y-1 text-center md:text-left">
              <h3 className="text-lg font-bold font-mono text-white flex items-center justify-center md:justify-start gap-2">
                <Server className="w-5 h-5 text-cyber-emerald" /> 03 // Swagger REST API Explorer
              </h3>
              <p className="text-xs text-gray-500 font-mono">
          ...
          <section id="projects" className="space-y-6">
            <div className="space-y-1 text-center md:text-left border-b border-gray-900 pb-4">
              <h3 className="text-lg font-bold font-mono text-white flex items-center justify-center md:justify-start gap-2">
                <GitFork className="w-5 h-5 text-cyber-cyan" /> 04 // Featured Deployments
              </h3>
              <p className="text-xs text-gray-500 font-mono">
          ...
          <section id="experience" className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-1 space-y-4 text-center lg:text-left">
              <div className="space-y-1">
                <h3 className="text-lg font-bold font-mono text-white flex items-center justify-center lg:justify-start gap-2">
                  <Briefcase className="w-5 h-5 text-cyber-indigo" /> 05 // Career Pipeline Log
                </h3>
                <p className="text-xs text-gray-500 font-mono">
              ...
              <div className="bg-gray-950/60 border border-gray-900 rounded-lg p-4 text-xs font-mono text-left">
                <p className="text-cyber-cyan font-bold mb-1">⚡ Core Highlights</p>
          ...
          <section className="space-y-6">
            <div className="space-y-1 text-center md:text-left border-b border-b-gray-900 pb-4">
              <h3 className="text-lg font-bold font-mono text-white flex items-center justify-center md:justify-start gap-2">
                <Cpu className="w-5 h-5 text-cyber-emerald" /> 06 // Stacks & Technical Toolkit
              </h3>
              <p className="text-xs text-gray-500 font-mono">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6 font-sans">
              <div className="bg-gray-950/60 border border-gray-900 rounded-lg p-5 space-y-3">
                ...
                <div className="flex flex-wrap gap-1.5">
                  {["TypeScript", "Python", "JavaScript", "SQL (PostgreSQL)", "PHP", "HTML5/CSS3"].map((s, i) => (
                    <span key={i} className="text-[10px] font-mono bg-black/40 border border-gray-900 px-2 py-0.5 rounded text-gray-300">{s}</span>
                  ))}
                </div>
              </div>
              <div className="bg-gray-950/60 border border-gray-900 rounded-lg p-5 space-y-3">
                <h4 className="font-mono text-xs font-bold text-cyber-emerald">// Stacks & ORMs</h4>
                <div className="flex flex-wrap gap-1.5">
              ...
              <div className="bg-gray-950/60 border border-gray-900 rounded-lg p-5 space-y-3">
                <h4 className="font-mono text-xs font-bold text-cyber-indigo">// Data & Message Queues</h4>
                <div className="flex flex-wrap gap-1.5">
              ...
              <div className="bg-gray-950/60 border border-gray-900 rounded-lg p-5 space-y-3">
                <h4 className="font-mono text-xs font-bold text-amber-500">// AI & Observability</h4>
                <div className="flex flex-wrap gap-1.5">
          ...
          <section id="contact" className="max-w-2xl mx-auto space-y-6 text-center">
            <div className="space-y-2">
              <h3 className="text-2xl font-bold text-white font-sans">Initialize System Query</h3>
              <p className="text-sm text-gray-400 max-w-md mx-auto font-sans leading-relaxed">
            ...
            <div className="glassmorphism rounded-lg border border-gray-800 p-6 text-left shadow-xl space-y-6">
              ...
              >
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-1">
                    <label className="text-[10px] font-mono text-gray-500 font-bold block">SENDER_NAME</label>
                    <input 
                      type="text" 
                      name="name"
                      required
                      placeholder="e.g. John Doe"
                      className="w-full bg-gray-950/60 border border-gray-900 rounded-md px-3 py-2 text-xs text-white font-mono outline-none focus:border-cyber-cyan"
                    />
                  </div>
                  <div className="space-y-1">
                    <label className="text-[10px] font-mono text-gray-500 font-bold block">SENDER_EMAIL</label>
                    <input 
                      type="email" 
                      name="email"
                      required
                ...
                <div className="space-y-1">
                  <label className="text-[10px] font-mono text-gray-500 font-bold block">QUERY_PAYLOAD_MESSAGE</label>
                  <textarea 
                    name="message"
                    required
                    rows={4}
                    placeholder="Provide a project overview or senior role details..."
                    className="w-full bg-gray-950/60 border border-gray-900 rounded-md px-3 py-2 text-xs text-white font-mono outline-none focus:border-cyber-cyan resize-none"
                  />
                </div>

                <button 
                  type="submit"
                  className="w-full px-4 py-3 bg-cyber-emerald hover:bg-emerald-600 active:scale-98 transition-all font-mono font-bold text-xs text-black rounded cursor-pointer flex items-center justify-center gap-1.5 shadow-[0_0_15px_rgba(16,185,129,0.15)]"
                >
                  <Send className="w-3.5 h-3.5 fill-black" /> DISPATCH_COMMUNICATION_INGEST()
                </button>
              </form>
            </div>
          </section>
